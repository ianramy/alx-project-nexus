...
from .profile_views import change_password, me, get_user_leaderboard, get_user_challenges, get_user_actions
...
urlpatterns = [
    ...
    path("me/", me, name="me"),
    path("me/password/", change_password, name="me-password"),
